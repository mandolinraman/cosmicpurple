...
d0 = cp.DiscreteDistribution.from_samples(data, 4, weights=weights)
...
d0 = cp.GaussianDistribution.from_samples(data, weights=weights)
...
d0 = cp.MultivariateGaussianDistribution.from_samples(data, weights=weights)
...
d0 = cp.ARGaussianDistribution.from_samples(data, weights=weights)
d1 = cp.MultivariateARGaussianDistribution.from_samples(
